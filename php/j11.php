...
class J11{
    ...
    public static function getTokyoDateTimeString($utc){
        try {
            if(is_numeric($utc)){
                $date = new DateTime();
                $date->setTimestamp(self::getUTC()/1000)->setTimezone(new DateTimeZone('Asia/Tokyo'));
                $date->modify('+9 hours');
